...
const formCls = "flex flex-col sm:grid sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 lg:gap-y-5 gap-6 gap-y-3 max-w-6xl items-start"
  ...
  return (
    <Page>
      <div className="flex flex-col  gap-6 justify-between h-full">
        ...
        <p className="text-center">powered by Hyper Ink - Tattoo Booking</p>
      </div>
    </Page>
  );
}
