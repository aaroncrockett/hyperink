...
//
import { AnimatedMenuIcon } from "@hyperink/ui-react/components";
    ...
    <div className={className}>
      <Dialog>
        ...
        <Portal>
          ...
          />
          <Dialog.Positioner className="z-50 fixed inset-0 flex justify-start">
            <Dialog.Content
              className={`h-screen bg-secondary-500/95 sm:w-2/3 md:w-1/2 w-[80%] lg:hidden shadow-sm relative ${animModal}`}
            >
              <div className="p-4 h-full">
                <div className="flex justify-between items-center">
                  <Dialog.Title className="pb-4 font-display text-primary-500 text-3xl">
